class WeatherConfig:
    def __init__(self):
        ...
        self.wg_frequency_seconds = 600  # fetch new data every 10 mins
        ...
        self.vc_frequency_seconds = 7200  # fetch new data every 2 hours
        ...
        self.aw_frequency_seconds = 120  # fetch new data every 2 minutes
